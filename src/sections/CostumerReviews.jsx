...
const CostumerReviews = () => {
  return (
    <section className="max-container">
      ...
      <p className="info-text m-auto mt-4 max-w-lg text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem blanditiis eveniet quaerat quos exercitationem numquam, alias cum laboriosam?</p>
